...
export const data: Question[] = [
  ...
  {
    question:
      "This sampling employs a simple rule of selecting every kth unit starting with a number chosen at random from 1 to k as the random start.",
    options: [
  ...
  {
    question:
      "A site was clear-cut. Which of these methods of regeneration cannot be used in a short timeframe?",
    options: [
